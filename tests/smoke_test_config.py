...
def test_validate_project_passes_on_valid_config(minimal_project_yaml, tmp_path):
    """validate_project() should not exit for a valid config."""
    import yaml
    ...
    validate_project(minimal_project_yaml, config_file)


def test_validate_project_catches_bad_gate_key(minimal_project_yaml, tmp_path):
    """validate_project() should sys.exit on a gate key not in the panel."""
    import copy
    import yaml
    from run_cifsquant import validate_project
    ...
    with pytest.raises(SystemExit):
        validate_project(bad_config, config_file)
